@echo off
REM =====================================================================
REM run_vip_check.bat - double-click entry for the S2 PS/PL co-sim check
REM
REM The real logic (AXI VIP generation + xvlog/xelab/xsim + gate) lives in
REM run_vip_check.ps1. This batch file only:
...
REM
REM Usage: run_vip_check.bat [rebuild]
REM =====================================================================
setlocal
cd /d "%~dp0"
...
if /i "%~1"=="rebuild" (
    powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0run_vip_check.ps1" -Rebuild
) else (
    powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0run_vip_check.ps1"
)
exit /b %errorlevel%
