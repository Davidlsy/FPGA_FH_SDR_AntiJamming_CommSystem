@echo off
REM =====================================================================
REM run_jammer_check.bat - double-click entry for the S2 jammer check
REM
REM The real logic (xvlog/xelab/xsim + python spectral/JSR check) lives in
REM run_jammer_check.ps1. This batch file only:
...
REM
REM Usage: run_jammer_check.bat
REM =====================================================================
setlocal
cd /d "%~dp0"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0run_jammer_check.ps1"
exit /b %errorlevel%
